...
# the color scheme
main_color = "#ECB176"
secondary_color = "#491909"
text_color = "white"

root.configure ( bg = main_color )

# title label
label_title = tk.Label( root, text = "PHP Currency Converter", font = ( "Rockwell", 18, "bold" ), bg = main_color, fg = text_color )
...
# amount entry
label_amount = tk.Label( frame_inputs, text = "Amount in PHP:", font = ( "Garamond", 14, "bold" ) , bg = main_color, fg = text_color )
label_amount.grid( row = 0, column = 0, padx = 10, pady = 10 )
entry_amount = tk.Entry( frame_inputs, bg = main_color, fg = text_color )
entry_amount.grid( row = 0, column = 1, padx = 10, pady = 10 )

# dropdown box
label_currency = tk.Label( frame_inputs, text = "Target Currency:", font = ( "Garamond", 14, "bold" ), bg = main_color, fg = text_color )
label_currency.grid( row = 1, column = 0, padx = 10, pady = 10 )

currency_options = fetch_currency_list()
combo_currency = ttk.Combobox( frame_inputs, values = currency_options, state = "normal" )
...
style.configure( "TCombobox", fieldbackground = main_color, background = main_color, foreground = text_color )

# convert button
button_convert = tk.Button( root, text = "CONVERT", command = convert_currency, font = ( "Rockwell", 12 ), bg = secondary_color, fg = text_color )
button_convert.pack( pady = 20 )

# result label
label_result = tk.Label( root, text = "", font = ( "Rockwell", 14 ), bg = main_color, fg = text_color )
